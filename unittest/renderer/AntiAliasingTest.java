...
public class AntiAliasingTest {
    ...
    AntiAliasingTest() { /* to satisfy JavaDoc generator */ }
    ...
    /** Produce a picture of spheres on polygon without antialiasing */
    @Test
    void withoutAntiAliasing() {
        ...
        camera //
                .build()
                .renderImage()
                .writeToImage("Without AntiAliasing spheres");
    }

    /** Produce a picture of spheres on polygon with antialiasing */
    @Test
    void withAntiAliasing() {
        ...
        camera //
                .setAntiAliasingResolution(9)
                .setMultithreading(-2)
                .build()
                .renderImage()
                .writeToImage("With AntiAliasing spheres");
    }
}
